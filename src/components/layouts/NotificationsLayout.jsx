...
const notifications = [
    { id: 1, message: 'Participante agregado en Proyecto de trabajo colaborativo: Juan Pérez', type: 'info' },
    { id: 2, message: 'Nuevo proyecto agregado: Proyecto de trabajo colaborativo', type: 'info' },
    { id: 3, message: 'Ticket agregado para el viaje a Bariloche', type: 'success' },
