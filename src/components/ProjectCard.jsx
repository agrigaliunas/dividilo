...
export const ProjectCard = ({ project }) => {
    ...
    return (
        <Link to={`/projects/${project.id}`} className='hover:bg-gray-50 border border-1 rounded-lg p-2 min-h-[30vh] shadow-md flex flex-col overflow-hidden gap-5'>
            ...
            <div className='flex flex-col justify-end items-center lg:gap-3 gap-10'>
                <div className='border border-1 rounded-full bg-gray-100 w-full h-fit'>
                    <div className='text-xl text-center p-2 font-bold'>Restante: ${project.montoTotal}</div>
                </div>
